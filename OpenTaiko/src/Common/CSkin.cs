...
internal class CSkin : IDisposable {
	...
	public void PrepareReloadSkin() {
		...
		this.bgmSongSelect_AI_In = new CSystemSound(@$"Sounds{System.IO.Path.DirectorySeparatorChar}BGM{System.IO.Path.DirectorySeparatorChar}SongSelect_AI_Start.wav", false, false, true, ESoundGroup.SongPlayback);
		this.bgmSongSelect_AI = new CSystemSound(@$"Sounds{System.IO.Path.DirectorySeparatorChar}BGM{System.IO.Path.DirectorySeparatorChar}SongSelect_AI.wav", true, false, true, ESoundGroup.SongPlayback);
				...
				try {
					...
					if (strArray.Length == 2) {
						...
						switch (strCommand) {
							...
							case "Title_Entry_Bar_Text_Scale": {
									Title_Entry_Bar_Text_Scale = int.Parse(strParam);
									break;
								}
							case "Title_Entry_Bar_Text1L": {
									Title_Entry_Bar_Text1L = strParam;
									break;
								}
							case "Title_Entry_Bar_Text1R": {
									Title_Entry_Bar_Text1R = strParam;
									break;
								}
							case "Title_Entry_Bar_Text2L": {
									Title_Entry_Bar_Text2L = strParam;
									break;
								}
							case "Title_Entry_Bar_Text2R": {
									Title_Entry_Bar_Text2R = strParam;
									break;
								}
							case "Title_Entry_Bar_Text1L_X": {
									Title_Entry_Bar_Text1L_X = int.Parse(strParam);
									break;
								}
							case "Title_Entry_Bar_Text1R_X": {
									Title_Entry_Bar_Text1R_X = int.Parse(strParam);
									break;
								}
							case "Title_Entry_Bar_Text2L_X": {
									Title_Entry_Bar_Text2L_X = int.Parse(strParam);
									break;
								}
							case "Title_Entry_Bar_Text2R_X": {
									Title_Entry_Bar_Text2R_X = int.Parse(strParam);
									break;
								}
							case "Title_Entry_Bar_Text1_Y": {
									Title_Entry_Bar_Text1_Y = int.Parse(strParam);
									break;
								}
							case "Title_Entry_Bar_Text2_Y": {
									Title_Entry_Bar_Text2_Y = int.Parse(strParam);
									break;
								}
	...
	public int[] Title_Entry_Bar_Text_X = new int[] { 0, 0 };
	public int[] Title_Entry_Bar_Text_Y = new int[] { 0, 0 };
	public int Title_Entry_Bar_Text_Scale = 48;
	public string Title_Entry_Bar_Text1L = "1人プレイ";
	public string Title_Entry_Bar_Text1R = "あと2コイン";
	public string Title_Entry_Bar_Text2L = "2人プレイ";
	public string Title_Entry_Bar_Text2R = "あと4コイン";
	public int Title_Entry_Bar_Text1L_X = 700;
	public int Title_Entry_Bar_Text1R_X = 1180;
	public int Title_Entry_Bar_Text2L_X = 700;
	public int Title_Entry_Bar_Text2R_X = 1180;
	public int Title_Entry_Bar_Text1_Y = 510;
	public int Title_Entry_Bar_Text2_Y = 690;
